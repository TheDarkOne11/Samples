 ...
 * @author Yaniv Inbar
 */
class AsyncLoadCalendars extends cz.cvut.fit.budikpet.googlecalendarsample.CalendarAsyncTask {
	...
	protected void doInBackground() throws IOException {
		CalendarList feed = client.calendarList().list().setFields(cz.cvut.fit.budikpet.googlecalendarsample.CalendarInfo.FEED_FIELDS).execute();
